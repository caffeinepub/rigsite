...
export class Backend implements backendInterface {
    ...
    async createBlogPost(arg0: BlogPost): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createBlogPost(to_candid_BlogPost_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterBlogPosts(arg0: Array<string>, arg1: boolean | null): Promise<Array<BlogPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterBlogPosts(arg0, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg1));
    ...
    async getBlogPosts(arg0: bigint, arg1: bigint): Promise<Array<BlogPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlogPosts(arg0, arg1);
                return from_candid_vec_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchContactForms(arg0: string): Promise<Array<ContactForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchContactForms(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactForm(arg0: ContactForm): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateBlogPost(arg0: BlogPost): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBlogPost(to_candid_BlogPost_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        tags: value.tags,
        author: value.author,
        coverImage: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.coverImage)),
